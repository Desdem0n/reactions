...
const PROJECTS = [
    {
        ...
        link: 'https://github.com/Desdem0n/WebDeveloper-React',
        image: project1
    },
    {
        id: 2,
        title: 'My API',
        description: 'An  API that I built from scratch with GET and POST requests!',
        link: 'https://github.com/Desdem0n/',
        image: project2
    },
    {
        id: 3,
